...
// Global variable for the size of the pages (initialized in main)
int pagesize = 1;

// Shared variable for totalling the counts

count_t counttotal;

void thread_count(int fd);
...
main(int argc, char *argv[]) {
  ...
  // We'll be working with a page at a time (per process)
